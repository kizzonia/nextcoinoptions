...
class WithdrawsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create withdraw" do
    assert_difference('Withdraw.count') do
      post withdraws_url, params: { withdraw: { amount: @withdraw.amount, email: @withdraw.email, payment_type: @withdraw.payment_type, plan: @withdraw.plan, user_id: @withdraw.user_id } }
    end
  ...
  test "should update withdraw" do
    patch withdraw_url(@withdraw), params: { withdraw: { amount: @withdraw.amount, email: @withdraw.email, payment_type: @withdraw.payment_type, plan: @withdraw.plan, user_id: @withdraw.user_id } }
