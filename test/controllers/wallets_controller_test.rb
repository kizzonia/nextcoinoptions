...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference('Wallet.count') do
      post wallets_url, params: { wallet: { Eth_wallet: @wallet.Eth_wallet, admin_user_id: @wallet.admin_user_id, btc_wallet: @wallet.btc_wallet, deposit_id: @wallet.deposit_id } }
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { Eth_wallet: @wallet.Eth_wallet, admin_user_id: @wallet.admin_user_id, btc_wallet: @wallet.btc_wallet, deposit_id: @wallet.deposit_id } }
