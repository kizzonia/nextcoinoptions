...
class WalletsTest < ApplicationSystemTestCase
  ...
  test "creating a Wallet" do
    ...
    fill_in "Eth wallet", with: @wallet.Eth_wallet
    fill_in "Admin user", with: @wallet.admin_user_id
    fill_in "Btc wallet", with: @wallet.btc_wallet
    fill_in "Deposit", with: @wallet.deposit_id
